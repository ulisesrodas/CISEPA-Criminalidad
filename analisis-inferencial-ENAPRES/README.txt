...
* **Lenguaje:** R
* **Documentación y Reportes:** Quarto (`.qmd`) para reportes reproducibles en PDF y HTML.
...
2. Descarga los microdatos originales de la ENAPRES desde el portal del INEI y colócalos en una carpeta llamada `datos/microdatos_enapres`.
